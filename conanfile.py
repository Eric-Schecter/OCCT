...
class OpenCascadeConan(ConanFile):
    ...
    def generate(self):
        ...
        # self define
        tc.cache_variables["USE_TCL"] = False
        # tc.cache_variables["CAN_USE_TK"] = False
        # tc.cache_variables["CAN_USE_XLIB"] = False
        # tc.cache_variables["CAN_USE_FREETYPE"] = False
        tc.cache_variables["USE_FREETYPE"] = False
        tc.cache_variables["USE_VTK"] = False
